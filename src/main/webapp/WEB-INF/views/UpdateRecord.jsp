...
<body class="insertBody">
  <form:form action="processUpdate" method="post" modelAttribute="book">
  
      <br><br> 
      <h2 class="textHeading text-uppercase">Record Updation</h2><br><br>
      ...
      <button type="submit" class="submitbtn">Update Record</button>
    </div>
  </form:form>
</body>
</html>